                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="copyright text-center pt-30 pb-50">
                                    <span>Copyright &copy; 2018 <a href="#">Best Selleer.</a> All rights reserved.</span>
                                </div>
            ...
            <?php require 'product-quick-view.php'; ?> 
        ...
        <script>
            let cartToCartButton = document.querySelector("#submit");
            cartToCartButton.addEventListener("click", (e) => {
                ...
                let url = `handlers/cart/new-cart.php?id=${productid}&name=${name}&price=${price}&quantity=${quantity}&size=${size}`;
