...
$payment = new Payment;
    ...
    if($saveOrder){
        ...
        if(isset($_POST['submit2'])){
            ...
            $_SESSION['success'] = "You Have Selected Payment on Delivery Successfully, The Company will Contact You To Confirm Your Orders, Please Kindly Logout To Begin Naother Transaction. Thanks";
            header('Location: ../.././');
        }else{
