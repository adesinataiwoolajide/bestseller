...
<div class="page-container">
    ...
    <div class="page-sidebar">
        ...
        <ul class="x-navigation">
            <li class="xn-logo">
                <a class="navbar-brand" href="./">GEMP</a>
            ...
            if($access ==1){ ?>
                ...
                <li class="xn-openable">
                    <a href=""><span class="fa fa-sitemap"></span> <span class="xn-text">Merchant</span></a>
                    <ul>
                        <li><a href="add-merchant.php"><span class="fa fa-align-center"></span> Add Merchant</a></li>
                        <li><a href="merchant-product.php"><span class="fa fa-align-justify"></span> View All Merchants</a></li>
                    </ul>         
                </li>

                
                <li class="xn-openable">
                    <a href=""><span class="fa fa-users"></span> <span class="xn-text">Delivery Allocation</span></a>
                    <ul>
                        <li><a href=""><span class="fa fa-book"></span> Allocate Delivery</a></li>
                        <li><a href=""><span class="fa fa-users"></span>View All Allocated</a></li>
                ...
                <li><a href=""><span class="fa fa-align-justify"></span> Products Panel</a></li>
                <li><a href="result-decision.php"><span class="fa fa-align-justify"></span> Products Store</a></li>
                
                <li class="xn-openable">
                    <a href=""><span class="fa fa-book"></span> <span class="xn-text">Staff Memo</span></a>
                    <ul>
                        <li><a href="add-memo.php"><span class="fa fa-align-center"></span> Add Memo</a></li>
                        <li><a href="view-all-memo.php"><span class="fa fa-align-justify"></span> View All Memo</a></li>
                    </ul>         
                </li>
                <li class="xn-openable">
                    <a href=""><span class="fa fa-user"></span> <span class="xn-text">Gallery</span></a>
                    <ul>
                        <li><a href="import-multple-galleries.php"><span class="fa fa-align-center"></span> Import Multiple Images</a></li>
                        <li><a href="view-all-gallery.php"><span class="fa fa-align-justify"></span> View All Galleries</a></li>
                    </ul>         
                </li>
               ...
               <?php
            ...
            }elseif(($access == 3) OR ($access == 10)){?>
                
                
                <li class="xn-openable">
                    <a href=""><span class="fa fa-book"></span> <span class="xn-text">School Memo</span></a>
                    <ul>
                        <li><a href="add-memo.php"><span class="fa fa-align-center"></span> Add Memo</a></li>
                        <li><a href="view-all-memo.php"><span class="fa fa-align-justify"></span> View All Memo</a></li>
                    </ul>         
                ...
                <li><a href="my-subjects.php"><span class="fa fa-book"></span> My Subject</a></li>
                
                <li>
                    <a href="all-students-results.php"><span class="fa fa-certificate"></span> 
                    Students Results</a>
                </li>
                <li class="">
                    <a href="view-school-memo.php"><span class="fa fa-inbox"></span> <span class="xn-text">View Memo</span></a>                        
                </li>
                <?php
            }  ?>
            <li class="">
